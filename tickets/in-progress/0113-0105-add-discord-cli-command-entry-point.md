...
The diff is clean and minimal. Let me verify the files quickly.
Everything checks out:

- **Ticket requirements**: All 4 code changes implemented correctly — case branch, `cmdDiscord` proc, `discord_cli.nim` stub, and Usage string updated after `audit`.
- **Conventions**: Import in bracket syntax with correct ordering, doc comments on both procs as complete sentences with punctuation, no forward declarations.
