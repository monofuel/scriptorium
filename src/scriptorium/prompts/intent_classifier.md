...
- ask: A question about the project that requires reading project state (read-only)
- plan: A request to change project direction, update the spec, or create work tickets
{{DO_INTENT}}
