...
- [x] `IT-LIVE-01` Real MCP transport test for orchestrator tool exposure.
...
- [x] `IT-LIVE-02` Real Codex MCP tool-calling integration.
...
- [x] `IT-LIVE-03` Real orchestrator daemon end-to-end runtime integration.
...
- [x] `IT-LIVE-04` Real daemon negative integration for missing `submit_pr`.
...
- [x] `IT-LIVE-05` Integration execution policy enforcement.
